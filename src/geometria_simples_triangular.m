function geometria_simples_triangular()

dados = fopen('exemplo_triangulos.txt');
...
[Kg,fg,matriz_dimensoes_elementos] = matriz_rigidez_triangulos_linear(matriz_de_incidencias,n_elementos,x,y,matriz_propriedades,n_nos);

[u] = condicao_fronteira_linear(matriz_tensoes,fg,Kg,matriz_propriedades,matriz_dimensoes_elementos,matriz_fronteira);

[x_aumentado,y_aumentado] = desenhar_malha_deformada(x,y,u,n_nos,matriz_de_incidencias,tipo_elmnt);

[epsilon,sigma,VMS] = tensao_extensao_triangulos_linear(matriz_propriedades,x,y,u,matriz_de_incidencias,n_elementos);
