function geometria_simples_quadrangular()

dados = fopen('exemplo_quadrados.txt');
...
[Kg,fg,matriz_dimensoes_elementos] = matriz_rigidez_quadrados_linear(matriz_de_incidencias,n_elementos,x,y,matriz_propriedades,n_nos);
...
[epsilon,sigma,VMS] = tensao_extensao_quadrados_linear(matriz_propriedades,x,y,u,matriz_de_incidencias,n_elementos);
