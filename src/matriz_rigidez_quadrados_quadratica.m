function [Kg,fg,matriz_dimensoes_elementos] = matriz_rigidez_quadrados_quadratica(matriz_de_incidencias,n_elementos,x,y,matriz_propriedades,n_nos)
...
for i=1:n_elementos
    ...
    DOF7 = (no7-1)*2+1;
    DOF8 = (no8-1)*2+1;
    nDOFS=[DOF1 DOF1+1 DOF2 DOF2+1 DOF3 DOF3+1 DOF4 DOF4+1 DOF5 DOF5+1 DOF6 DOF6+1 DOF7 DOF7+1 DOF8 DOF8+1];
    
    [Ke, fe] = Elem_ElasQuad8(XN,C,he,0); %Carregamento nulo
