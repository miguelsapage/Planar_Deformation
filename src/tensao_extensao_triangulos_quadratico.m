function [epsilon,sigma,VMS] = tensao_extensao_triangulos_quadratico(matriz_propriedades,x,y,u,matriz_de_incidencias,n_elementos)
...
for i=1:n_elementos
    ...
    DOFS = [DOF1 DOF1+1 DOF2 DOF2+1 DOF3 DOF3+1 DOF4 DOF4+1 DOF5 DOF5+1 DOF6 DOF6+1];
    ...
    [sigma(i,:), epsilon(i,:)] = Stress_Strain_TRI6(XN,C,delta,xi,eta);
