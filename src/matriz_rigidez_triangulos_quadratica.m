function [Kg,fg,matriz_dimensoes_elementos] = matriz_rigidez_triangulos_quadratica(matriz_de_incidencias,...
...
for i=1:n_elementos
    ...
    DOF5 = (no5-1)*2+1;
    DOF6 = (no6-1)*2+1;
    nDOFS=[DOF1 DOF1+1 DOF2 DOF2+1 DOF3 DOF3+1 DOF4 DOF4+1 DOF5 DOF5+1 DOF6 DOF6+1];
    
    [Ke, fe] = Elem_ElasTRI6 (XN,C,he,0);
