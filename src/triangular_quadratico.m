function triangular_quadratico()

dados = fopen('placa_triangulos_quadratico.txt');
...
[Kg,fg,matriz_dimensoes_elementos] = matriz_rigidez_triangulos_quadratica(matriz_de_incidencias,n_elementos,x,y,matriz_propriedades,n_nos);
...
[epsilon,sigma,VMS] = tensao_extensao_triangulos_quadratico(matriz_propriedades,x,y,u,matriz_de_incidencias,n_elementos);
